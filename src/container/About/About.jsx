...
const About = () => {
  ...
  const abouts = [
    ...
    },
    {
      ...
      description:
        "Developing feature-rich and user-interactive apps for companies and individuals and helping them to experience a smarter tools to solve their business needs using cutting-edge frameworks (ReactJS,Typescript)",
    },
    {
      title: "Back End Developer",
      imgUrl: images.about04,
      description:
        "Appling Business logic, Creating secured REST  APIs by leveraging the Power of Single thread run time environment(NodeJS) best practices for more than 1+ years.",
    },
    {
